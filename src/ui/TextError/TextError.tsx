...
/**
 * The TextError component is a classic HTML "h2" tag with some styles added. Below you can see an example of its use.
 * @example
 * <TextError align="center" dimension="small">TextError</TextError>
 */
